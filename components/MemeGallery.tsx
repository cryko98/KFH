...
const MemeGallery: React.FC = () => {
  return (
    <section id="gallery" className="py-20 bg-dojo-cream relative">
       {/* Background accent */}
       <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-dojo-red/5 rounded-full blur-3xl"></div>
       <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-96 h-96 bg-hamster-orange/5 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-dojo-charcoal text-lg max-w-2xl mx-auto">
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
          {MEME_GALLERY_IMAGES.map((imgUrl, index) => (
            <div key={index} className="break-inside-avoid relative group rounded-2xl overflow-hidden border border-stone-200 bg-white shadow-md hover:shadow-xl hover:shadow-dojo-red/10 transition-all duration-300">
              <img 
                src={imgUrl} 
                alt={`Meme ${index + 1}`} 
